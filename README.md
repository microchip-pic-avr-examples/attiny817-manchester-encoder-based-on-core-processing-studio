...
# Manchester Encoder Based on Core Processing
...
This example has now illustrated how you can implement a Manchester Encoder using core processing and a single TCB peripheral.
